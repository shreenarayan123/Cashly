    ...
    <div className='flex h-screen  py-5 px-5 gap-5 bg-slate-200'>
		<Toaster/>
			...
			<h2 className="text-3xl py-5 font-bold tracking-tighter sm:text-5xl bg-gradient-to-r from-[#ff6b6b] via-[#ffa500] to-[#8b008b] bg-clip-text text-transparent">
				...
				<UpdateProfile/>
				<div className='flex flex-col items-center gap-9 bg-red-100 rounded-2xl border-2 border-red-900 w-[60%] lg:w-[40%]  py-4 px-8'>
					<h2 className='text-xl relative right-24 lg:right-36 font-semibold text-red-900'>Danger Zone</h2>
					<span onClick={handleDelete} className='text-base  py-2 w-[55%] lg:w-[40%] cursor-pointer hover:bg-red-600 text-center border-2 border-red-500 rounded-2xl bg-white font-semibold text-red-600 hover:text-white'>Delete Account</span>
